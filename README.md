...
* [redis](http://godoc.org/github.com/ctrlaltdel121/radix/redis) - A wrapper around a
  single redis connection. Supports normal commands/response as well as
  pipelining.

    * [resp](http://godoc.org/github.com/ctrlaltdel121/radix/redis/resp) - A utility
...
* extra - a sub-package containing added functionality
    ...
    * [sentinel](http://godoc.org/github.com/ctrlaltdel121/radix/extra/sentinel) - a
